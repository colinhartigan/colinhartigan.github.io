...
function Home(props) {
    ...
    const schools = [
        {
            ...
            "dates": "fall 2018 - spring 2022",
            "remarks": "hands-on courses instructed by industry professionals; completed python 1-3, circuits 1, C 1-2, cybersecurity 1"
        },
        {
            "name": "marriotts ridge high school",
            "dates": "september 2018 - may 2022",
            "remarks": "curriculum focus in STEM; student government executive board advisor; computer science club mentor"
        },
        {
            "name": "georgia institute of technology",
            "dates": "august 2022 - (expt.) may 2026",
            "remarks": "bachelor of science in computer engineering; computing hardware & emerging architectures + devices thread"
        },
    ]
    ...
    return (
        <>
                ...
                <div className="absolute w-auto h-auto flex flex-col items-center justify-center">
                    <div className="p-2 flex flex-col align-center justify-center ">
                        ...
                        <div className="flex flex-row align-center justify-center">
                            <p className="text-2xl border-2 border-black border-t-0 p-2 font-medium grow text-center">
                                MD 🡢 ATL
                            </p>
                            <p className="text-2xl border-2 border-black border-l-0 border-t-0 py-2 px-5 font-medium text-center">
                                ECE 2026
                            </p>
                        </div>
                    </div>
            ...
            <div className="h-screen max-h-screen mx-auto max-w-[80%] xl py-7 flex flex-col items-start justify-start">
                    ...
                    <div className="relative flex flex-col items-start h-auto z-10 pl-8">
                        ...
                        <div className="w-8/12 text-2xl border-2 border-black p-2 bg-white">
                            <p className=" text-left h-full">
                                I'm Colin, a computer engineering student from Maryland. I'm an avid programmer and tinkerer.
                            </p>
                        </div>
                    </div>
                ...
                <div className="relative h-[50%] md:h-full w-full">
                    <div className="relative flex flex-col items-end h-auto z-10 pr-8">
                        ...
                        <div className="w-8/12 grow text-2xl border-2 border-b-0 border-black bg-white">

                            <div className="flex flex-col justify-start align-center">

                                {schools.map((element, index) => {
                                    return <GridRow data={element} key={index} />
                                })}
