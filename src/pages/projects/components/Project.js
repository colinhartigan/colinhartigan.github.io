        ...
        <div className="w-full h-auto">
            ...
            <div className="w-full h-full flex flex-row items-stretch justify-start">
                ...
                <div className="min-h-full w-auto px-5 flex flex-row items-center justify-center border-black border-r-2 border-b-2 border-t-2">
                    <a href={`https://github.com/${data.github}`} target="_blank" rel="noreferrer" className="text-lg text-center underline">
                        github
                    </a>
                </div>
            ...
            <div className="w-full h-36 flex flex-col items-center justify-start border-black border-l-2 border-r-2 border-b-2">
