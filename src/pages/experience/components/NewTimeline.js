                    ...
                    {data.map((item, index) => {
                        return (
                            <div className="w-full h-auto flex flex-row justify-center items-center grow">
                                ...
                                <div className="w-auto h-auto flex grow flex-col justify-center items-start gap-2">
                                    <p className="text-3xl flex grow pl-2 pr-16">
                                        {item.org}
                                    </p>

                                    <div className="w-full h-auto flex grow border-black border-b-2" />

                                    <div className="w-full h-auto pr-4 pl-2 flex flex-row justify-start items-center gap-8">
                                ...
                                <div className="w-40 h-[50%] flex flex-col justify-center items-center gap-2">
